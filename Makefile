...
SINGULAR	= /cygdrive/c/lapa/sing/Singular-f5-like/ix86-Win/Singular-3-1-4

BUILD_SUBDIRS	=  omalloc ntl factory libfac kernel Singular IntegerProgramming doc emacs dyn_modules
BUILD1_SUBDIRS	=  omalloc ntl factory libfac kernel Singular IntegerProgramming
SUBDIRS		=  omalloc MP ntl factory libfac kernel IntegerProgramming Singular doc emacs dyn_modules

PERL		= perl
TMP_DIR		= /cygdrive/c/lapa/sing/Singular-f5-like/tmp
MYGZIP		= gzip -9
GUNZIP		= gunzip
...
install install_all:
	...
	echo "* do not forget to install Singular-3-1-4-share.tar.gz"
...
#
S_VERSION             = $${SINGULAR_VERSION-3-1-4}
SINGUNAME	      = ix86-Win
localdir              = /usr/local
